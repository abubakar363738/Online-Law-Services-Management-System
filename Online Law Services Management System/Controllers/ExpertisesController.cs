...
namespace Online_Law_Services_Management_System.Controllers
{
    public class ExpertisesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ExpertiseId,Expertise1")] Expertise expertise)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ExpertiseId,Expertise1")] Expertise expertise)
        {
            if (ModelState.IsValid)
            {
